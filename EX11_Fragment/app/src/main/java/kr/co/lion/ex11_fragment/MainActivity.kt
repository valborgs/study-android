...
// Fragment 기반의 애플리케이션 작업 시 초기 작성 코드 순서
// 1. activity_main.xml에 FragmentContainerView를 배치해준다.
// 2. MainActivity.kt 파일에 Fragment 들의 이름을 표현하기 위한 enum class를 작성해준다.
// 3. MainActivity에 oldFragment와 newFragment 프로퍼티를 정의해준다.
// 4. fragment basic code.txt에 있는 메서드 코드를 붙여넣는다.
// 5. 빨간색으로 뜨는 부분들은 import해준다.
